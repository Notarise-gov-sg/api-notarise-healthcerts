...
it("should create the unwrapped document from input data with empty signedEuHealthCerts", () => {
  const createdDocument = createUnwrappedDocument(
    sampleDocument,
    uuid,
    storedUrl,
...
it("should create the unwrapped document from input data with signedEuHealthCerts", () => {
  const createdDocument = createUnwrappedDocument(
    sampleDocument,
    uuid,
    storedUrl,
