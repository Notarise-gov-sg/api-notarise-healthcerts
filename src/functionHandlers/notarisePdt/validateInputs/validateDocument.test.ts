...
it("should throw on v2 document failing when document data id string invalid", async () => {
  ...
  await expect(validateV2Document(sampleDocumentV2InvalidId)).rejects.toThrow(
    'The following required fields are missing: [{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"issuers"},"message":"must have required property \'issuers\'"},{"instancePath":"/id","schemaPath":"#/properties/id/type","keyword":"type","params":{"type":"string"},"message":"must be string"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"version"},"message":"must have required property \'version\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"type"},"message":"must have required property \'type\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"validFrom"},"message":"must have required property \'validFrom\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"fhirVersion"},"message":"must have required property \'fhirVersion\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"fhirBundle"},"message":"must have required property \'fhirBundle\'"}]. For more info, refer to the mapping table here: https://github.com/Notarise-gov-sg/api-notarise-healthcerts/wiki'
  );
});
...
it("should throw on v2 document failing when document data validFrom invalid", async () => {
  ...
  await expect(
    ...
    'The following required fields are missing: [{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"issuers"},"message":"must have required property \'issuers\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"type"},"message":"must have required property \'type\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"fhirVersion"},"message":"must have required property \'fhirVersion\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"fhirBundle"},"message":"must have required property \'fhirBundle\'"},{"instancePath":"/validFrom","schemaPath":"#/properties/validFrom/format","keyword":"format","params":{"format":"date-time"},"message":"must match format \\"date-time\\""}]. For more info, refer to the mapping table here: https://github.com/Notarise-gov-sg/api-notarise-healthcerts/wiki'
  );
});
...
it("should throw on v2 document failing when document data fhirVersion invalid", async () => {
  ...
  await expect(
    ...
    'The following required fields are missing: [{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"issuers"},"message":"must have required property \'issuers\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"type"},"message":"must have required property \'type\'"},{"instancePath":"","schemaPath":"#/required","keyword":"required","params":{"missingProperty":"fhirBundle"},"message":"must have required property \'fhirBundle\'"}]. For more info, refer to the mapping table here: https://github.com/Notarise-gov-sg/api-notarise-healthcerts/wiki'
  );
});
